...
traits<-read.csv("./Raw_Data/Fish_traits_products/Species_List_Final.csv") ## what is this file....
...
## going to join these seperately to the smalelr dataframe
#c("FRS_Common.Name","LmaxFB","LWRa","SubFactor")
