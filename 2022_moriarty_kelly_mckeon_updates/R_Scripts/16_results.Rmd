...
list<-c("ggplot2", "data.table", "reshape2", "arm","car", "DMwR", "Hmisc",
        ...
        "sf", "glmmTMB", "DHARMa", "sjPlot", "ggpubr", "ggfortify")
...
a$groups <- 1
a$groups[a$taxon %in% c(#"Scophthalmus rhombus",
  "Lamna nasus", "Polymetme thaeocoryla", 
  "Gadus morhua")] <- 0
...
autoplot(pc, data = a, #colour = "grey", 
        ...
        colour = c("red" , "grey")[a$groups],
         loadings = TRUE,
         loadings.label = TRUE, loadings.colour = " dark grey", #loadings.label.size = 5, 
...
autoplot(pc, data = a,
         ...
         y =3,
           colour = c("red" , "grey")[a$groups],
         loadings = TRUE,
         loadings.label = TRUE, loadings.colour = " dark grey",
         loadings.label.colour = "black")
...
# Scophthalmus rhombus - highest fecundity 

# Lamna nasus - portobegel, highest offsprin size (episodic)

# Polymetme thaeocoryla - opertunistic - fastest growth co-efficeint 
```
