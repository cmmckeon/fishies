...
# 
# worms_taxonomy <- wm_records_taxamatch(abundance$taxon[1:50])
# worms_taxonomy <- wm_records_taxamatch(abundance$taxon[51:100])
# worms_taxonomy <- wm_records_taxamatch(abundance$taxon[101:150])
# worms_taxonomy <- wm_records_taxamatch(abundance$taxon[151:200])
# worms_taxonomy <- wm_records_taxamatch(abundance$taxon[200:220])
# 
# 
# c <- as.data.frame(t(1:length((worms_taxonomy[[1]]))))
# names(c) <- names(worms_taxonomy[[1]])
