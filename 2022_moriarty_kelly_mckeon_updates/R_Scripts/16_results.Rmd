...
setwd("~/Library/CloudStorage/OneDrive-Personal/PhD/Fishies/fishies/2022_moriarty_kelly_mckeon_updates")
depth <- as.raster(readRDS("./Regional Boundaries Maps and Data/papoue_bathy_map.rds"))
...
```{r}
par(mfrow =c(1,2), bty = "n", yaxt="n", xaxt="n", mar = c(1,1,1,1))
# plot(tmp_raster, ext=extent(tmp_raster),xaxs="i",yaxs="i")
# plot(land, col = "white", add =T, ext=extent(tmp_raster),xaxs="i",yaxs="i")
# points(sp_co$x, sp_co$y, cex = 0.5)

plot(t50, ext=extent(tmp_raster),xaxs="i",yaxs="i")
plot(land, col = "white", add =T, ext=extent(tmp_raster),xaxs="i",yaxs="i")
points(x$x, x$y, cex = 7)
...
par(mfrow = c(3,2), bty = "n", yaxt="n", xaxt="n", mar = c(1,1,1,1))

plot(tmp_raster, ext=extent(tmp_raster),xaxs="i",yaxs="i")
plot(t50, ext=extent(tmp_raster),xaxs="i",yaxs="i")
plot(land, col = "white", add =T, ext=extent(tmp_raster),xaxs="i",yaxs="i")
plot(depth, ext=extent(tmp_raster),xaxs="i",yaxs="i")
plot(d50, ext=extent(tmp_raster),xaxs="i",yaxs="i")
plot(land, col = "white", add =T, ext=extent(tmp_raster),xaxs="i",yaxs="i")
plot(f, ext=extent(tmp_raster),xaxs="i",yaxs="i")
plot(fp50, ext=extent(tmp_raster),xaxs="i",yaxs="i")
plot(land, col = "white", add =T, ext=extent(tmp_raster),xaxs="i",yaxs="i")
