...
g_pc1$main1 <- factor(g_pc1$main1, levels = c("DepthNew", "SNSP", "SNWI", "sst_var",  "fp","Quarter","Year"))
g_pc1$term <- factor(g_pc1$term, levels = c("DepthNew", "SNSP", "SNWI", "sst_var", "fp", "DepthNew:fp", "SNSP:fp", "SNWI:fp",  "sst_var:fp",
                                             "SNSP:SNWI", "SNSP:sst_var", "SNWI:sst_var", "SNSP:DepthNew",  "SNWI:DepthNew", "sst_var:DepthNew", 
                                              "Quarter", "Year"))
...
g_pc2$main1 <- factor(g_pc2$main1, levels = c("DepthNew", "SNSP", "SNWI", "sst_var",  "fp","Quarter","Year"))
g_pc2$term <- factor(g_pc2$term, levels = c("DepthNew", "SNSP", "SNWI", "sst_var", "fp", "DepthNew:fp", "SNSP:fp", "SNWI:fp",  "sst_var:fp",
                                             "SNSP:SNWI", "SNSP:sst_var", "SNWI:sst_var", "SNSP:DepthNew",  "SNWI:DepthNew", "sst_var:DepthNew", 
                                              "Quarter", "Year"))
...
g_pc3$main1 <- factor(g_pc3$main1, levels = c("DepthNew", "SNSP", "SNWI", "sst_var",  "fp","Quarter","Year"))
g_pc3$term <- factor(g_pc3$term, levels = c("DepthNew", "SNSP", "SNWI", "sst_var", "fp", "DepthNew:fp", "SNSP:fp", "SNWI:fp",  "sst_var:fp",
                                             "SNSP:SNWI", "SNSP:sst_var", "SNWI:sst_var", "SNSP:DepthNew",  "SNWI:DepthNew", "sst_var:DepthNew", 
                                              "Quarter", "Year"))
```
...
#g_pc1$rep[g_pc1$main %in% c("SNSP", "SNWI", "sst_var", "DepthNew")] <- "white"
g_pc1$rep[g_pc1$main %in% c("fp", "SNSP:fp", "SNWI:fp", "sst_var:fp","DepthNew:fp")] <- "grey"
...
ggplot(g_pc1,  aes(term, estimate)) +
  ...
  geom_line() +
    ...
    geom_rect(data = g_pc1[g_pc1$rep != "white",],
            aes(NULL, NULL, xmin = cat -0.5, xmax = cat+0.5, ymin = -Inf, ymax = Inf), col = "grey", alpha = 0.15) +
  ...
  geom_pointrange(data = g_pc1, shape = 1,
    ...
    geom_point(data = g_pc1, 
                    ...
                    position = position_dodge(0.5), size = 4) + #ylim(-0.11, 0.11) +        
...
a3 <- a3 + theme(axis.text.x = element_text(angle = 45, vjust = 0.5, hjust=1)) 
...
g1$main1 <- factor(g1$main1, levels = c("DepthNew", "SNSP", "SNWI", "sst_var",  "fp","Quarter","Year"))
g1$term <- factor(g1$term, levels = c("DepthNew", "SNSP", "SNWI", "sst_var", "fp", "DepthNew:fp", "SNSP:fp", "SNWI:fp",  "sst_var:fp",
                                             "SNSP:SNWI", "SNSP:sst_var", "SNWI:sst_var", "SNSP:DepthNew",  "SNWI:DepthNew", "sst_var:DepthNew", 
                                              "Quarter", "Year"))
...
g2$main1 <- factor(g2$main1, levels = c("DepthNew", "SNSP", "SNWI", "sst_var",  "fp","Quarter","Year"))
g2$term <- factor(g2$term, levels = c("DepthNew", "SNSP", "SNWI", "sst_var", "fp", "DepthNew:fp", "SNSP:fp", "SNWI:fp",  "sst_var:fp",
                                             "SNSP:SNWI", "SNSP:sst_var", "SNWI:sst_var", "SNSP:DepthNew",  "SNWI:DepthNew", "sst_var:DepthNew", 
                                              "Quarter", "Year"))
...
g3$main1 <- factor(g3$main1, levels = c("DepthNew", "SNSP", "SNWI", "sst_var",  "fp","Quarter","Year"))
g3$term <- factor(g3$term, levels = c("DepthNew", "SNSP", "SNWI", "sst_var", "fp", "DepthNew:fp", "SNSP:fp", "SNWI:fp",  "sst_var:fp",
                                             "SNSP:SNWI", "SNSP:sst_var", "SNWI:sst_var", "SNSP:DepthNew",  "SNWI:DepthNew", "sst_var:DepthNew", 
                                              "Quarter", "Year"))
```
...
b3 <- b3 + theme(axis.text.x = element_text(angle = 45, vjust = 0.5, hjust=1)) 
...
# b1 <- ggplot(g1,  aes(term, estimate)) +
  #     geom_hline(yintercept= 0, alpha = 0.8) +
  # geom_line() +
...
# b2 <- ggplot(g2,  aes(term, estimate)) +
#       geom_hline(yintercept= 0, alpha = 0.8) +
#   geom_line() +
#   geom_pointrange(data = g2, shape = 1,
#                     aes(term, estimate, colour = main1,ymin= conf.low, ymax= conf.high),
#                     position = position_dodge(0.5), size = 1.5) +
#     geom_point(data = g2,
#                     aes(term, estimate, colour = main2), position = position_dodge(0.5), size = 4) + ylim(-0.11, 0.11) + 
#     scale_color_manual(values = c("SNSP" = "#414487FF",
#                                   "SNWI" = "#2A788EFF",
#                                   "sst_var" = "#7AD151FF",
#                                   "DepthNew" =  "orange",
...
# 
# 
# b3 <- ggplot(g3,  aes(term, estimate)) +
#       geom_hline(yintercept= 0, alpha = 0.8) +
#   geom_line() +
...
autoplot(pc, data = a, colour = "grey",# colour = cb_pal[a$body.shape], 
         loadings = TRUE,
         loadings.label = TRUE, loadings.colour = "grey", loadings.label.size = 4,
