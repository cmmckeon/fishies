...
## shape-based plot of all resolution models
...
## res 1
sum.df <- as_tibble(m1[m1$res == 0.1,])
sum.df <- as_tibble(sum.df[, c("term", "estimate", "std.error", "statistic", "p.value")])
sum.df %>% 
  kable(booktabs = T, caption = "Table C.1.1. Model outputs for communities at the level of haul") %>%
...
sum.df <- as_tibble(sum.df[, c("term", "estimate", "std.error", "statistic", "p.value")])
sum.df %>% 
  kable(booktabs = T, caption = "Table C.1.2. Model outputs for communities at the level of haul") %>%
  kable_styling(bootstrap_options = "striped", full_width = T) %>%
    row_spec(which(sum.df$statistic < -2), color = "red", background = "white") %>%
  row_spec(which(sum.df$statistic >2), color = "blue", background = "white") %>% 
  kable_styling(font_size = 11)
...
sum.df <- as_tibble(sum.df[, c("term", "estimate", "std.error", "statistic", "p.value")])
sum.df %>% 
  kable(booktabs = T, caption = "Table C.1.3. Model outputs for communities at the level of haul") %>%
  kable_styling(bootstrap_options = "striped", full_width = T) %>%
    row_spec(which(sum.df$statistic < -2), color = "red", background = "white") %>%
  row_spec(which(sum.df$statistic >2), color = "blue", background = "white") %>% 
  kable_styling(font_size = 11)
...
sum.df <- as_tibble(sum.df[, c("term", "estimate", "std.error", "statistic", "p.value")])
sum.df %>% 
  kable(booktabs = T, caption = "Table C.1.4. Model outputs for communities at the level of haul") %>%
  kable_styling(bootstrap_options = "striped", full_width = T) %>%
    row_spec(which(sum.df$statistic < -2), color = "red", background = "white") %>%
  row_spec(which(sum.df$statistic >2), color = "blue", background = "white") %>% 
  kable_styling(font_size = 11)
...
sum.df <- as_tibble(sum.df[, c("term", "estimate", "std.error", "statistic", "p.value")])
sum.df %>% 
  kable(booktabs = T, caption = "Table C.1.5. Model outputs for communities at the level of haul") %>%
  kable_styling(bootstrap_options = "striped", full_width = T) %>%
    row_spec(which(sum.df$statistic < -2), color = "red", background = "white") %>%
  row_spec(which(sum.df$statistic >2), color = "blue", background = "white") %>% 
  kable_styling(font_size = 11)
