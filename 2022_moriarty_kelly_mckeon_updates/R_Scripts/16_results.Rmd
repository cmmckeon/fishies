...
list<-c("ggplot2", "data.table", "reshape2", "arm","car", "DMwR", "Hmisc",
        ...
        "sf", "glmmTMB", "DHARMa", "sjPlot", "ggpubr")
...
b1 <- ggplot(g1,  aes(term, estimate, colour = res)) +
  ...
  geom_pointrange(data = g1,
                    ...
                    position = position_dodge(0.5), size = 1.5) #+ ylim(-0.25, 0.25) #+ ylim(-0.15, 0.25)
...
```{r}
autoplot(pc, data = a, colour = a$feeding.mode, loadings = TRUE,
